...
export default function ReactionGif({ gameState }) {
  ...
  return (
    ...
    >
      ...
      <h3
        style={
          feedback.message === "Waiting for your move..."
            ? { marginTop: "10px", color: "black", whiteSpace: "nowrap" }
            : feedback.message === "😬 Not Matched!"
            ? { marginTop: "10px", color: "red", whiteSpace: "nowrap" }
            : { marginTop: "10px", color: "green", textAlign: "center" }
        }
      >
        {" "}
        {feedback.message}{" "}
